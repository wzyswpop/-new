define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'yp/freight/index' + location.search,
                    add_url: 'yp/freight/add',
                    edit_url: 'yp/freight/edit',
                    del_url: 'yp/freight/del',
                    multi_url: 'yp/freight/multi',
                    import_url: 'yp/freight/import',
                    table: 'yp_freight',
                }
            });
                        ...
                        for (var cityIndex in cityIds) {
                            if (cityIds.hasOwnProperty(cityIndex)) {
                                ...
                                if (!checked) {
                                    ...
                                    if(checkedIndex === -1 && !this.inArray(cityId,this.disable.citys)){
